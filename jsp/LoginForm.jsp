        ...
        <div class="row">
            ...
            <div >
                ...
                <h1>로그인창 입니다.</h1>
                    ...
                    <div>
                        <input type="submit" value="                      일반 로그인                      " class="btn btn-primary">
                    ...
                    <c:if test="${sessionScope.id eq null }">
									...
									<a href="https://kauth.kakao.com/oauth/authorize?client_id=020c086d2f07c389f780777fec4cf86d&redirect_uri=http://smhousegrid.com:8083/travel1/Kakao.do&response_type=code&scope=account_email">
									<img alt="" src="/travel1/image/kakao_login_medium_wide.png">
									</a>
								</c:if>
                    </div>
